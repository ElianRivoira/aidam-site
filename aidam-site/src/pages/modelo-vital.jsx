...
const modeloVital = () => {
  return (
    <main className='min-h-screen'>
      ...
      <div className={`${styles.gradient} bg-aidamBlue text-white py-[8%] px-8 flex justify-center`}>
        <div className='text-center w-full sm:w-1/2 mx-2'>
          <h1 className='font-libreBaskerville text-4.5xl mb-2'>¿Cómo funciona nuestro modelo vital?</h1>
      ...
      <div className='my-[3%] relative sm:flex'>
        <div className='rounded-full border-[35px] mb-3 sm:mb-0 border-aidamBlue h-[450px] w-[450px] overflow-hidden relative -left-20 lg:static flex-shrink-0'>
          <Image src={ninoPreescolar} alt='imagen circular' width={450} className='' />
        </div>
        <div className='px-8 sm:px-0 sm:flex sm:flex-col sm:justify-center'>
...
const questions = [
  ...
  },
  {
    id: 2,
    question: 'Question 2',
    answer: 'Es un lugar especializado en el tratamiento terapéutico NO farmacológico del adulto mayor con deterioro leve y/o moderado cuyo objetivo central es promover la autonomía e independencia de nuestros asistentes.  Su ser querido encontrará en nuestro Centro un equipo de profesionales entrenado y capacitado que lo ayudará a desarrollar al máximo las capacidades y habilidades que aún permanecen activas, permitiéndole permanecer en su hogar el mayor tiempo posible, evitando y/o retrasando en el tiempo una posible institucionalización geriátrica.',
  },
  {
    id: 3,
    question: 'Question 3',
